...
public class Server {
	...
	private void run(String portNumber) {
		...
		server.createContext("/user/register", new RegisterHandler());  // Post
		server.createContext("/user/login", new LoginHandler());  // Post
		server.createContext("/clear", new ClearHandler());  // Post
		server.createContext("/fill", new FillHandler());  // Post
		server.createContext("/load", new LoadHandler());  // Post
		server.createContext("/person", new PersonHandler());  // Get
		server.createContext("/event", new EventHandler());  // Get
		server.createContext("/", new FileHandler());  // Get
